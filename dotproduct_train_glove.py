...
from dotproduct_models_glove import Seq2Seq, Decoder, Encoder, Attention, init_weights
...
def get_embeddings(embedding_size, vocab_size, args):
    representations = torch.load('/yoav_stg/gshalev/image_captioning/output_folder/glove_representations_for_NMT',
                                 map_location=device)
